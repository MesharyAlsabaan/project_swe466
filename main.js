...
document.querySelector('#button31').style.display='none';
...
document.querySelector('#button21').addEventListener('click',function () {
    ...
    for(var i=resources.length-1; i<resources.length; i++)
    {
        var x = document.getElementById("res1");
        var option = document.createElement("option");
        option.text=resources[i].resourcename;
        x.add(option);
...
document.querySelector('#m4').addEventListener('click',function () {
    if (d5.style.display=='none'){
        ...
        document.querySelector('#button31').style.display='unset';}
    else {
        document.querySelector('#t2').style.display='none';
        document.querySelector('#button31').style.display='none';
    }

    document.querySelector('#tid2').addEventListener('change',function () {
        var id = document.getElementById("tid2").value;

        if(id < tasks.length+1){
            document.getElementById("i1").value = tasks[id-1].taskname;
            document.getElementById("i2").value = tasks[id-1].tduration;
            document.getElementById("i3").value = tasks[id-1].startdate;
            document.getElementById("i4").value = tasks[id-1].finshdate;
        }
        else {
            alert("no tasks");
        }
...
document.querySelector('#button31').addEventListener('click',function () {
...
//// Display with the cost
var d9=document.getElementById("table7");
document.querySelector('#button7').addEventListener('click',function () {
    if (d9.style.display=='none'){
        document.querySelector('#table7').style.display='unset';
    }
    else {
        document.querySelector('#table7').style.display='none';
    }
...
//////////////////// display cosy for whole project
var d10=document.getElementById("table8");
document.querySelector('#button8').addEventListener('click',function () {
    if (d10.style.display=='none'){
        document.querySelector('#table8').style.display='unset';
    }
    else {
        document.querySelector('#table8').style.display='none';
    }
...
function addrows( d) {
    ...
    row.insertCell(0).innerHTML=document.getElementById("tid2").value;
    row.insertCell(1).innerHTML= document.getElementById("i1").value;
    row.insertCell(2).innerHTML= document.getElementById("i2").value;
    row.insertCell(3).innerHTML= document.getElementById("i3").value;
    row.insertCell(4).innerHTML= document.getElementById("i4").value;
    row.insertCell(5).innerHTML= document.getElementById("res1").value;
}
...
var x;
    for(var i=0 ;i<resources.length;i++){
        if (resources[i].resourcename==document.getElementById("res1").value){
             x= resources[i].rate;
        }
    ...
    row.insertCell(4).innerHTML= document.getElementById("i4").value;
    row.insertCell(5).innerHTML= document.getElementById("res1").value;
    row.insertCell(6).innerHTML= totalcost;
}
...
function addrows8( d) {
    ...
    var totalcost=x*8*y;
    totalcostprojecr=totalcostprojecr+totalcost;
...
if (h==true){
    ...
    row1.insertCell(6).innerHTML=totalcostprojecr;
    h=false;
}
else {
    alert("hello");
